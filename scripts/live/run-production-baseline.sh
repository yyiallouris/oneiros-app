...
SCENARIO_FILE="${1:-testing/live-scenarios/production-baseline.copper-vessel.v3-9-0.json}"
...
EMAIL="oneiros.v390.prod+$(date +%s)@example.com"
PASS="V390ProdTest!$(openssl rand -hex 4)"
...
export LIVE_BASELINE_SCENARIO_FILE="$SCENARIO_FILE"
npx --yes tsx scripts/live/run-production-baseline.ts
