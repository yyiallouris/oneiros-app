...
EMAIL="oneiros.myth.calibration+$(date +%s)@example.com"
PASS="MythCalibration!$(openssl rand -hex 4)"
...
export MYTH_BENCHMARK_CONCURRENCY="${MYTH_BENCHMARK_CONCURRENCY:-2}"

npx --yes tsx scripts/run-naturalistic-myth-benchmark.ts
