...
Offline Q2 final status: frozen `oneiros-same-call-reflective-questions-v1.0.5-candidate` / `16da1d13…` returned **HOLD** after its one 22-call source-ownership evaluation. It achieved human Q2 `17/22`, repaired `3/4` v1.0.4 failures, and preserved pair complementarity `22/22`, but controls were only `4/6` equivalent, unseen holdout was `9/12`, Q1 regression check was `20/22`, and recurring failure families remained. It and predecessor v1.0.4 are explicitly denied; Q2 prompt R&D stops with no v1.0.6 or deploy authorized. Production identities above remain unchanged. Review: [`ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md).

Offline adaptive-cardinality final status: three frozen prompt-only shots ended **HOLD / STOP**. Final v0.3.0 `13eea607…` improved minimum-sufficient stopping but reached only `5/10` target+quality PASS and retained three serious premise/menu failures. All adaptive-opening candidates are denied and isolated under R&D; no fourth candidate or deploy is authorized. Production Quick 1 / Standard-Advanced 2 remains unchanged. Review: [`ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md`](./ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md).

Exact-prompt blind confirmation: after explicit reopening for confirmation only, frozen Shot 3 was compared with production across 20 fresh multilingual dreams / 40 calls (`$0.60746000`, no retries). It achieved earned cardinality `20/20`, including three winning one-question endings, but blind preference was only `11–9`, would-ship was `16/20` versus production `18/20`, and it produced three serious answer menus. The gate failed, so adaptive cardinality is parked as a future Oneiros v2 architecture/product question rather than another prompt-clause task. Review: [`ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md`](./ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md).
...
Closed historical R&D (Director/Composer, v1.2 orchestration, Gate/Repair, v5 initial, editorial arc, Inviter v1/v2.0.1), the failed v1.0.2 surgical prompt, held v1.0.4 imaginal-handoff Q2 candidate, and final held v1.0.5 source-ownership Q2 candidate are not selectable production identities. The promoted v1.0.3 enacted-relation prompt (`f5399a49…`) completed one frozen Q1 evaluation with human Q1 `21/21`; its one missing-heading failure is repaired by deterministic frozen replay and production normalizer v1.0.0. Production Q2 remains unchanged, and Q2 prompt R&D is stopped. Records: [`ONEIROS_QUESTION_REPAIR_PHASE2_EDITORIAL_FAIL_2026-08-29.md`](./ONEIROS_QUESTION_REPAIR_PHASE2_EDITORIAL_FAIL_2026-08-29.md), [`REFLECTIVE_QUESTION_PRODUCTION_HOLD.md`](./REFLECTIVE_QUESTION_PRODUCTION_HOLD.md), [`ONEIROS_V102_SURGICAL_ROOT_CAUSE_2026-08-29.md`](./ONEIROS_V102_SURGICAL_ROOT_CAUSE_2026-08-29.md), [`ONEIROS_V103_ENACTED_RELATION_CANDIDATE_2026-08-29.md`](./ONEIROS_V103_ENACTED_RELATION_CANDIDATE_2026-08-29.md), [`ONEIROS_V103_ENACTED_RELATION_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V103_ENACTED_RELATION_EVALUATION_REVIEW_2026-08-29.md), [`ONEIROS_V104_IMAGINAL_HANDOFF_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V104_IMAGINAL_HANDOFF_EVALUATION_REVIEW_2026-08-29.md), [`ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md).
