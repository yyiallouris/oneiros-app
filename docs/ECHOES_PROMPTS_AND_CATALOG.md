...
> **2026-08-30 adaptive-opening R&D boundary:** frozen offline candidates v0.1.0 `da717215…`, v0.2.0 `ca2dbedb…`, and final v0.3.0 `13eea607…` changed only reflective-opening selection/cardinality wording on the approved Reader base. The three-shot line returned HOLD / STOP; no candidate is a runtime import or deployment identity. It made **no** extraction prompt/schema, Echo shape/catalog, `display_distillation`, metadata, language-gate, chat, essay, RDF, or production change. Production remains v1.0.3 / `f5399a49…`. Review: [`ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md`](./ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md).

> **2026-08-30 adaptive blind-confirmation boundary:** the exact frozen Shot 3 `13eea607…` was later compared blind with production on 20 fresh synthetic multilingual dreams / 40 paid calls after explicit approval. It earned cardinality `20/20` but won only `11–9`, was less often shippable (`16/20` versus `18/20`), and created three serious answer menus. The gate failed and the line is parked for Oneiros v2. This confirmation made **no** extraction prompt/schema, Echo shape/catalog, `display_distillation`, metadata, language-gate, chat, essay, RDF, runtime, or deployment change. Review: [`ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md`](./ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md).

> **2026-08-29 final Q2 R&D boundary:** frozen Reader candidate `oneiros-dream-reflection-v3.2.5-candidate` / question bundle SHA `16da1d13…` changed only the Standard/Advanced Q2 composition job relative to held v1.0.4 and returned **HOLD** after its one 22-call evaluation. It is denied, Q2 prompt R&D is stopped, and production remains v1.0.3 / `f5399a49…`. This experiment made **no** extraction prompt/schema, Archetypal/Mythic Echo catalog, `display_distillation`, metadata, language-gate, chat, essay, RDF, or production deployment change. Review: [`ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md).

> **2026-08-29 offline Q2 boundary:** frozen Reader candidate `oneiros-dream-reflection-v3.2.4-candidate` / question bundle SHA `a4f972c…` changed only the Standard/Advanced Q2 composition job and returned **HOLD** after one 21-call evaluation. It is denied and has no runtime import. Production remains v1.0.3 / `f5399a49…`. This experiment made **no** extraction prompt/schema, Archetypal/Mythic Echo catalog, `display_distillation`, metadata, language-gate, chat, essay, RDF, or production deployment change. Review: [`ONEIROS_V104_IMAGINAL_HANDOFF_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V104_IMAGINAL_HANDOFF_EVALUATION_REVIEW_2026-08-29.md).
