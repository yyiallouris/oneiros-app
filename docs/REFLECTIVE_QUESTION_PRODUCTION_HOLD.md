...
**Final Q2 R&D:** `oneiros-same-call-reflective-questions-v1.0.5-candidate` / SHA `16da1d13…` is **HOLD and explicitly denied** after its one frozen 22-call source-ownership evaluation. Human Q2 passed `17/22`; it repaired `3/4` held-v1.0.4 failures, but protected controls were only `4/6` equivalent, fresh unseen holdout was `9/12`, Q1 regression check was `20/22`, and recurring failure families remained. One control regression was serious. No v1.0.6, runtime import, or deployment is authorized; further Q2 prompt clauses are not recommended. The current production Q2 is intentionally retained, and this prompt-iteration line stays closed unless a future architecture/product decision explicitly reopens it. Production remains exactly v1.0.3. Record: [`ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md). Its held predecessor v1.0.4 remains preserved and denied: [`ONEIROS_V104_IMAGINAL_HANDOFF_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V104_IMAGINAL_HANDOFF_EVALUATION_REVIEW_2026-08-29.md).

**Adaptive-opening R&D:** the separately authorized v0.1.0 → v0.2.0 → final v0.3.0 prompt-only line is **HOLD / STOP and denied**. Shot 3 candidate `oneiros-adaptive-reflective-openings-v0.3.0-final-candidate` / SHA `13eea607…` reached only `5/10` full target+quality PASS against `9/10`, with three serious premise/menu failures. The experiment preserved vitality but could not make one-versus-two selection stable across static, relational, multilingual, and ambiguous dreams. No fourth prompt candidate, production import, deploy, or cardinality change is authorized. Production remains exactly v1.0.3 / `f5399a49…`, Standard/Advanced exactly two. Record: [`ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md`](./ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md).

**Adaptive-opening blind confirmation:** one later owner/PO-authorized confirmation changed no prompt: exact frozen Shot 3 `13eea607…` ran head-to-head against production on a fresh sealed 20-dream multilingual fixture. Forty calls cost `$0.60746000`, with zero retries. Shot 3 earned cardinality `20/20`, but blind preference was only `11–9`, would-ship was `16/20` versus production `18/20`, and Shot 3 introduced three serious answer menus. It failed the pre-registered superiority and quality gates and is **PARKED FOR ONEIROS V2**. No Shot 4, rewrite, runtime import, deployment, or fixed-cardinality change is authorized. Record: [`ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md`](./ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md).
