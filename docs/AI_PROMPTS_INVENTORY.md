...
> **Adaptive reflective openings final HOLD (2026-08-30):** the isolated prompt-only line tested whether Quick could choose its strongest source and Standard/Advanced could return one or two questions only when earned. Frozen candidates v0.1.0 `da717215…`, v0.2.0 `ca2dbedb…`, and final v0.3.0 `13eea607…` used one sealed ten-dream synthetic multilingual fixture. Final Shot 3 improved the stopping boundary but achieved only `5/10` target+quality PASS, with three serious premise/menu failures and unstable overproduction/over-pruning; vitality remained `10/10`. The line is HOLD / STOP with no fourth candidate or deploy. These modules are denied R&D-only and have no production import. Production remains v1.0.3 / `f5399a49…`, fixed cardinality, normalizer v1.0.0, gateway v113. Review: [`ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md`](./ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md).

> **Adaptive Shot 3 blind confirmation (2026-08-30):** after explicit owner/PO approval, the exact unchanged v0.3.0 `13eea607…` ran against production v1.0.3 on 20 fresh sealed synthetic dreams / 40 calls (`$0.60746000`, no retries). Blind preference was Shot 3 `11` / production `9`; would-ship was `16/20` / `18/20`; earned cardinality was `20/20` / `18/20`; serious answer menus were `3` / `2`. Shot 3 failed the pre-registered superiority, menu, recurring-family, and full-reading gates. It remains denied/offline and adaptive `1–2` is parked for Oneiros v2. This was not a fourth prompt candidate and changed no prompt bytes or production surface. Review: [`ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md`](./ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md).

> **Final Q2 source-ownership evaluation (2026-08-29):** `oneiros-same-call-reflective-questions-v1.0.5-candidate` / SHA `16da1d13fb480dd57ef013a7e8241a8309ec06c67d3e1d071089cb24f54cf67a`, Reader `oneiros-dream-reflection-v3.2.5-candidate`, is frozen and **HOLD / denied** after its one authorized 22-call run. It changed only the Standard/Advanced Q2 composition job relative to held v1.0.4. Human Q2 `17/22`, v1.0.4 failures repaired `3/4`, protected controls equivalent `4/6`, fresh unseen holdout `9/12`, pair complementarity `22/22`, Q1 regression check `20/22`, structure `22/22`; exact cost `$0.33537750`. A serious control regression and recurring manufactured-category, control-vitality, generic-Q2, Q1-regression, and source-boundary families failed the strict SHIP gate. Q2 prompt R&D is stopped; do not create v1.0.6 automatically. Production remains v1.0.3 / `f5399a49…`, with no runtime or deployment change. Review: [`ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V105_SOURCE_OWNERSHIP_EVALUATION_REVIEW_2026-08-29.md).

> **Offline Q2 imaginal-handoff evaluation (2026-08-29):** `oneiros-same-call-reflective-questions-v1.0.4-candidate` / SHA `a4f972c00bbde525ad3f39db160afd18e3a1c18f8a92090e0eb7078b137e277d`, Reader `oneiros-dream-reflection-v3.2.4-candidate`, is frozen and **HOLD / denied** after its only authorized 21-call run. It replaced only the Standard/Advanced Q2 composition job. Human Q2 `17/21`, known repairs `2/3`, controls `5/6`, unseen `10/12`, pair complementarity `21/21`, Q1 regression check `20/21`, structure `21/21`; cost `$0.31680500`. The exact candidate failed zero-regression and recurring-family gates. It is offline only; production remains v1.0.3 / `f5399a49…`, with no prompt, model, validator, streaming, extraction, chat, essay, RDF, or deployment change. No automatic v1.0.5. Review: [`ONEIROS_V104_IMAGINAL_HANDOFF_EVALUATION_REVIEW_2026-08-29.md`](./ONEIROS_V104_IMAGINAL_HANDOFF_EVALUATION_REVIEW_2026-08-29.md).
...
| Reflective-question R&D | isolated at `src/ai/rd/reflective-questions/`; Q2 v1.0.4 SHA `a4f972c…` and final source-ownership v1.0.5 SHA `16da1d13…` are HOLD/denied; v1.0.5 failed its strict 22-call gate and closes Q2 prompt R&D with no automatic v1.0.6; frozen Candidate B SHA `08cd3eaf…`; Candidate C SHA `c2b0f766…` closed `MIXED — STOP`; remainder-first SHA `a37426d1…` closed `MIXED — STOP`; local Oneiros Reader v1.4.0 SHA `0ea4b9a2…` is archived `DO NOT DEPLOY`; hold module is not a runtime import; [`REFLECTIVE_QUESTION_PRODUCTION_HOLD.md`](./REFLECTIVE_QUESTION_PRODUCTION_HOLD.md) |
