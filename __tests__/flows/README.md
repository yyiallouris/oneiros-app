...
| `reflectiveQuestions.productionDeployGuard.contract.flow.test.ts` | flows-06 **locked deploy hold + R&D isolation** (recovered remote psychological-aliveness v1.4.0 SHA `4885e351…`; fail-closed `npm run deploy:ai-entitlements-gateway`; R&D under `src/ai/rd/reflective-questions/`; Candidate B SHA `08cd3eaf…` frozen; mega-runner archived) |
