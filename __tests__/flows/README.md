...
| `reflectiveQuestions.productionDeployGuard.contract.flow.test.ts` | flows-06 **locked deploy hold** (recovered remote psychological-aliveness v1.4.0 SHA `4885e351…`; fail-closed `npm run deploy:ai-entitlements-gateway`; local Oneiros Reader v1.4.0 denied; recovered snapshot not imported by client/gateway; mega-runner frozen) |
