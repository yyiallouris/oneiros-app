...
- The Journal header preserves its editorial spacing while clearing the device top safe area. Its list uses the shared floating-tab content inset, including the bottom safe area, so the final slip can scroll fully above the parchment shelf. The shelf hides while the search keyboard is open. Active tabs use medium labels and full-strength glyphs; inactive labels retain accessible contrast while their glyphs recede without a selection pill. The Journal tab keeps the light open-book concept but gains authored movement through a perceptible page lift, unequal lower-curve cadence, variable line pressure, and a softly wandering spine. It intentionally has no witness dot or selection badge. Calendar and microphone retain their original non-bold Oneiros PNGs at their authored canvas proportions, without tint or forced crop; search/edit/send/copy/chevrons retain their paths and share the rounded functional stroke. Every parent control keeps at least a 44dp touch target.
