...
| AI interpretation and chat | `DreamDetailScreen`, `InterpretationChatScreen`, `ai.ts` | OpenAI/proxy, extraction, metadata cache, interpretation sync | flow 06 (incl. metadata resilience + streaming typing + recovered v105 reflective-question identity + fail-closed deploy + isolated R&D), architecture interpretation, AI/display tests |
