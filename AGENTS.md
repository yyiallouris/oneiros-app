...
Final adaptive-opening feasibility line: after explicit owner approval, frozen v0.1.0 / `da717215…`, v0.2.0 / `ca2dbedb…`, and final v0.3.0 / `13eea607…` tested variable Standard/Advanced one-versus-two selection. After the strict three-shot HOLD, one explicitly authorized confirmation compared the exact unchanged Shot 3 with production on 20 fresh sealed multilingual synthetic dreams / 40 calls. Shot 3 earned cardinality `20/20`, but blind preference was only `11–9`, would-ship was `16/20` versus production `18/20`, and it produced three serious answer menus. The pre-registered gate failed and adaptive cardinality is **HOLD / PARK FOR ONEIROS V2**. All three candidates remain denied offline evidence. Do not deploy, create a fourth candidate, continue prompt clauses, or change production cardinality without a future explicit product/architecture reopening. Production remains v1.0.3 / `f5399a49…`, Quick 1 and Standard/Advanced exactly 2. Reviews: `docs/ONEIROS_ADAPTIVE_REFLECTIVE_OPENINGS_THREE_SHOT_REVIEW_2026-08-30.md`, `docs/ONEIROS_ADAPTIVE_OPENINGS_SHOT3_VS_PRODUCTION_CONFIRMATION_REVIEW_2026-08-30.md`.
